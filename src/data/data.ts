...
export let data: IApplicationInfo[] = [
    ...
    },
    {
        ...
        applicationStatus: "Active",
        sites: [
            {type: "main", url: "https://github.com/davatorium/rofi"},
    ...
    },
    {
        ...
        itemsHaveMultipleActions: {
            value: false,
            tooltip:
                "Alfred has a separate system for dealing with files, where file items do have multiple actions. However normal items in Alfred do not have multiple actions",
        },
        applyActionsAcrossMultipleItems: false,
        searchableSubMenusAndContextMenus: "N/A",
        fileSearch: true,
    ...
    },
    {
        ...
        applicationStatus: "Active",
        sites: [
            {type: "main", url: "https://github.com/jopemachine/arvis"},
