        ...
        categories={[
            ...
            },
            {
                ...
                data: {
                    ...
                    calculatorParserType: {
                        description: "The type of parser used",
                        Comp: ({data}) => <div>{data}</div>,
                    },
                    ...
                    calculatorSupportsCustomDecimalSeperator: {
                        description: "Does calculator support custom decimal seperator?",
                        css: colorBoolean,
                        Comp: ({data}) => <div>{getPlannedBooleanItemIcon(data)}</div>,
                    },
                    calculatorSupportsCustomThousandsSeperator: {
                        description:
                            "Does calculator support custom thousands seperator?",
                        css: colorBoolean,
                        Comp: ({data}) => <div>{getPlannedBooleanItemIcon(data)}</div>,
                    },
